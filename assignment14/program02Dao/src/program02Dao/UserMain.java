		...
		while ((choice = menu()) != 0) {
			...
			case 3:
				...
				try(UserDAO dao=new UserDAO()){
					...
					int id=sc.nextInt();
					u.setId(id);
					System.out.print("Enter the first name to be updated=");
					String fname=sc.next();
					u.setFirst_name(fname);
					System.out.print("Enter the last name to be updated=");
					String lname=sc.next();
					u.setLast_name(lname);
					System.out.print("DEnter the password to be updated=");
					String password=sc.next();
					u.setPassword(password);
					System.out.print("enter the new date to updated(dd-mm-yyyy)=");
					String date=sc.next();
					u.setDob(date);
