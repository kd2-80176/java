...
public class Tester {
	...
	Set<Library> book= new TreeSet<Library>();
...
//it we not any compareble then class cast exception is given
//when we used compareble then give output in random order 
	}
